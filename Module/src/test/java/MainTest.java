...
class MainTest {
    ...
    void addSession(){
        ...
        MainGUI.SessionList exp = new MainGUI.addInOrder( test ,null);
    ...
    void displaySession(){
        ...
        assertEquals("ID = 1234 Title = whar Mentor = mr.dooks Date = 2026-09-01 Location = build 5 Participants = 15 Current Num = 2\n--------------------\n",area.getText() );
